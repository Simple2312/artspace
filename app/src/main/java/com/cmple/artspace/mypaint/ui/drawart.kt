...
import kotlinx.android.synthetic.main.activity_drawart.*
import pub.devrel.easypermissions.AppSettingsDialog
import pub.devrel.easypermissions.EasyPermissions

class drawart : AppCompatActivity(), EasyPermissions.PermissionCallbacks {
    ...
    private val TAG = "drawart"
    private val STORAGE_PERM = 333

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_drawart)
